...
def mapjson(course, uid, course_key = ['original_date','course_name','recommended_prerequisite','instructor','in_person_ta','webex_ta','course_length','description','topics_covered', 'additional_resources', 'register', 'software_needed', 'class_type']):
